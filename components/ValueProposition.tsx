...
const ValueProposition: React.FC = () => (
  <section id="audit" className="py-24 bg-slate-950 relative overflow-hidden border-t border-slate-900">
     {/* Grid Background */}
    ...
    <div className="container mx-auto px-6 relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="p-8 bg-slate-900/40 backdrop-blur-sm rounded-2xl border border-slate-800 hover:border-logo-green/30 transition-all text-center group">
        ...
        <div className="p-8 bg-slate-900/40 backdrop-blur-sm rounded-2xl border border-slate-800 hover:border-logo-teal/30 transition-all text-center group">
        ...
        <div className="p-8 bg-slate-900/40 backdrop-blur-sm rounded-2xl border border-slate-800 hover:border-logo-blue/30 transition-all text-center group">
